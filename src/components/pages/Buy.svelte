	...
	<div class='home'>
			...
			<div class='hero-inner'>
				...
				<div class='token-icon-wrap'>
					<div class='token-icon' in:fade={{ duration: 1500 }}>
						<img src='/bcp-3d.png' title='BCP logo' alt='BCP logo' />
					</div>
				</div>

				<div class='button-wrap'>
					<a class='button' href='https://app.uniswap.org/#/swap?inputCurrency=ETH&outputCurrency=0x031d35296154279dc1984dcd93e392b1f946737b' target="_blank">Buy BCP on Uniswap</a>
		...
		<div class='about'>
			...
			<div class='item'>
				...
				<p>Stake BCP to get a share of income</p>
			</div>
