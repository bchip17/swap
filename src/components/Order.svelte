...
<div class='order' class:loading={$isSubmittingLong || $isSubmittingShort}>
	...
	{#if !$address}
	<div class='note'>BlueChip is an open protocol to trade crypto perpetuals with 0 fees. <a data-intercept="true" on:click={() => {showModal('Connect')}}>Connect your wallet</a> on Arbitrum to get started.</div>
	{:else if $address && balance * 1 == 0}
	<div class='note'><a href='https://docs.blueswap.net/setting-up-your-wallet' target='_blank'>Bridge funds</a> to Arbitrum to start trading.</div>
	{/if}
